...
\column{0.5\textwidth}
\centering
\includegraphics[width=0.6\textwidth]{statechartbypassante.png}
\end{columns}
\vspace*{5mm}
\begin{itemize}
...
\begin{columns}
\column{0.5\textwidth}
\animategraphics[loop,width=\textwidth]{30}{snap}{1}{304}
\column{0.5\textwidth}
Dati
\begin{itemize}
...
\animategraphics[loop,width=0.9\textwidth]{30}{snap}{1}{221}
\column{0.5\textwidth}
\centering
\graphicspath{ {../simulazioni/minimiLocaliMesh} }
\animategraphics[loop,width=0.9\textwidth]{30}{snap}{1}{200}
\end{columns}
\vspace{2mm}
\begin{columns}
\column{0.5\textwidth}
...
\begin{columns}
\column{0.5\textwidth}
\animategraphics[loop,width=\textwidth]{30}{snap}{1}{327}
\column{0.5\textwidth}
\begin{itemize}
