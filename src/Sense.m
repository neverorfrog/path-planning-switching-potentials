classdef Sense
    ...
    methods
        ...
        function dObstacle = scan(obj,robot)
            ...
            for j = 1 : n
                ...
                %[inradius,distance] = obj.invisionradius(robot,o);
                if inradius && obj.intube(tube,o)
                    dObstacles{j} = o;
    ...
    methods(Access=private)
        ...
        function tube = tube(~,robot)
            pose = robot.getPose(); 
            rx = pose(1); ry = pose(2); thetar = pose(3);
            grid = robot.grid;
            G = grid.goal;
            rm = 2.5;
            ...
            x1 = rx + deltaX + eps*cos(thetar); y1 = ry - deltaY + eps*sin(thetar);
            x4 = rx - deltaX + eps*cos(thetar); y4 = ry + deltaY + eps*sin(thetar);
            ...
            tube.x1 = x1; tube.x4 = x4; tube.angle = angle; tube.eps = eps;
        end
